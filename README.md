...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-08 20:19`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/834763ee-0c03-4e2b-b7de-9d7433fefae0.git
$ cd 834763ee-0c03-4e2b-b7de-9d7433fefae0
```
